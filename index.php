...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg navbar-default navbar-fixed-top" style="background-color: rgba(255,255,255,0.85);">
            ...
            <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="navbarCollapse" style="">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="discover-link"><a href="#contact" class="discover-btn">Contact</a></li>
        ...
        <div class="container-fluid ">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center padding-bottom-10">
                    ...
                    <h2 class="section-title white-text">Our Products</h2>

                    <p class="section-subtitle white-text">Best product is our pride</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="feature-box orange wow fadeIn" data-wow-delay="0.75s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
                        ...
                        <div class="feature-box-text">
                            ...
                            <p>Comitted We will try our best to build trust with our partners around the world.</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="feature-box dark-blue wow fadeIn" data-wow-delay="1.25s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
                        ...
                        <div class="feature-box-text">
                            ...
                            <p>Quality as a sales and services that make it easier for customers to qualify a product as well as possible.</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="feature-box light-red wow fadeIn" data-wow-delay="1.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
                        ...
                        <div class="feature-box-text">
                            ...
                            <p>Inovated By developing our potential and production more optimally we strive to meet the commodity needs of the world market.</p>
    ...
    <!--begin blog section -->
    <section class="section-white" id="article">
...
<script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?4849';
