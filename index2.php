...
<body>
    ...
    <div class="alert header-alert alert-danger alert-dismissible text-center fade show" role="alert">
        Don't miss out! Download our free guide <a href="#" class="alert-link">here</a>.
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg navbar-default navbar-fixed-top">
            ...
            <div class="container">
                    ...
                    <!--begin logo -->
                    <a class="navbar-brand" href="#">SalesPage</a>
                    <!--end logo -->
		...
		<div class="container">
	        ...
	        <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="hero-text">Excepteur sint occaecat cupidatat nonet proident, vante nisn culpa qui officia deserunt etimus quis autem nets lorem entimus velis netsad.</p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 wow slideInLeft" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: slideInLeft;">
                    ...
                    <div class="margin-right-15">
                        ...
                        <img src="images/about2.jpg" class="width-100 image-shadow bottom-margins-images" alt="pic">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h3>Many reasons to choose us.</h3>

                    <p>Velis demo enim ipsam voluptatem quia voluptas sit aspernatur netsum lorem fugit, seditum netis velas matrix net nesciunt.</p>
                
                    <p class="blockquote-left">Velis demo enim ipsam voluptatem quia voluptas sit aspernat netsum lorem fugit, seditum netis velas matrix net nesciunt sequi quia netsa situm aspernatur netsum.</p>
                
                    <p>Voluptatem quia voluptas sit aspernatur netsum lorem fugit, seditum netis velas matrix net nesciunt sequi quia netsa.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <h3 class="section-title">We helped more than 75 great businesses</h3>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <ul class="partners-mentions">
                        ...
                        <li><img src="images/award02.png" alt="CSS Awards"></li>

                        <li><img src="images/award01.png" alt="Awwwards"></li>

                        <li><img src="images/award03.png" alt="CSS Winner"></li>

                        <li><img src="images/award04.png" alt="CSS Design Awards"></li>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="iframe-youtube">
                        ...
                        <iframe width="860" height="498" src="https://www.youtube.com/embed/_UZeLBWPVwI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7 mx-auto text-center">
                    ...
                    <a href="#" class="btn-white small scrool">Get More Details</a>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6">
                    ...
                    <div class="small-col-inside">
                        ...
                        <h3>Top four ways to lead a high performing, experienced team.</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" id="headingThree">
                                    ...
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                      Neque quis autem reprehenderit
                                    </button>
                                    </h5>
                                </div>
        ...
        <div class="container-fluid ">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center padding-bottom-10">
                    ...
                    <h2 class="section-title white-text">Our Work</h2>

                    <p class="section-subtitle white-text">Here are a few examples of what we do.</p>
                ...
                <div class="col-sm-6 blog-item">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#">
                                <img src="images/blog1.jpg" class="width-100 blog-image" alt="pic">
                            </a>
                ...
                <div class="col-sm-6 blog-item">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#">
                                <img src="images/blog2.jpg" class="width-100 blog-image" alt="pic">
                            </a>
                ...
                <div class="col-sm-6 blog-item">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#">
                                <img src="images/blog3.jpg" class="width-100 blog-image" alt="pic">
                            </a>
                ...
                <div class="col-sm-6 blog-item">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#">
                                <img src="images/blog4.jpg" class="width-100 blog-image" alt="pic">
                            </a>
    ...
    <section class="section-white" id="contact">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!--begin col-md-6 -->
                <div class="col-md-6 bottom-margins-images">
        ...
        <div class="container footer-top">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p><a href="mailto:contact@youremail.com">the-office@salespage.co.uk</a></p>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <a href="#" class="footer-links">Meet The Team Behind SalesPage</a>
        ...
        <div class="container-fluid footer-bottom px-0">
            ...
            <div class="row no-gutters mx-0">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p>Copyright © 2020 <span class="template-name">SalesPage</span>. Designed by <a href="https://themeforest.net/user/epic-themes/portfolio?ref=Epic-Themes" target="_blank">Epic-Themes</a></p>
